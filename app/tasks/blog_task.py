...
@celery.task(name="send_all_blogs_deleted_email_task", autoretry_for=(Exception,), retry_kwargs={'max_retries': 3})
def send_all_blogs_deleted_email_task(email: str):
    send_all_blogs_deleted_email(email)